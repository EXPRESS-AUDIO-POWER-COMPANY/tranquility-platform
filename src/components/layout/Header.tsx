    ...
    <header className="sticky top-0 z-50 border-b border-black/5 bg-tranquility-ivory/95 backdrop-blur-xl">
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3.5 lg:px-8">
        <Link aria-label={`${siteConfig.name} home`} className="group flex items-center gap-3" to="/">
          <span className="grid size-10 place-items-center rounded-full bg-tranquility-charcoal font-serif text-xl text-white shadow-soft transition-transform group-hover:scale-[1.03]">
            T
          </span>
          <span>
        ...
        <button
          ...
          className="grid size-11 place-items-center rounded-full border border-black/10 bg-white shadow-sm lg:hidden"
      ...
      {open ? (
        <nav aria-label="Mobile navigation" className="border-t border-black/5 bg-tranquility-ivory px-5 pb-5 lg:hidden">
